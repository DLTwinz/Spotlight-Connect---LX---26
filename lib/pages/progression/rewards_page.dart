...
class _ProofHistoryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tint = switch (event.kind) {
      ...
      ProofEventKind.purchase => theme.colorScheme.tertiary,
      ProofEventKind.subscription => theme.colorScheme.primary,
      ProofEventKind.tip => theme.colorScheme.error,
      ProofEventKind.attendance => theme.colorScheme.secondary,
      ProofEventKind.milestone => theme.colorScheme.primary,
    };
