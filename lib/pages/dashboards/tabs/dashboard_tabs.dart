          ...
          Column(
            ...
            children: [
              ...
              Text(
                trend,
                style: TextStyle(
                  color: trend.contains('+') || trend.contains('SECURE') ? accentColor : Colors.redAccent,
                  fontSize: 10,
                  fontWeight: FontWeight.bold,
                ),
              ),
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  radius: 18,
                  child: Icon(isTalent ? Icons.bolt : Icons.analytics_outlined, color: accentColor, size: 18),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            isTalent ? 'CONVERSION CAPTURED' : 'PROMPT IMPACT METRIC',
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Icon(isTalent ? Icons.campaign : Icons.token_outlined, color: accentColor, size: 40),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    ...
                    children: [
                      Text(
                        isTalent ? 'SQUADRON AUDIO // IMPACT MISSION' : 'CREATOR NODE #${4022 + index}',
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            isTalent ? 'ESCROW BUDGET: \$2,400' : 'VERIFIED IMPACT: 94.2%',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text(
          isTalent ? 'CREATOR OPERATIONS ENGINE' : 'BRAND IMPACT ENGINE',
          style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 1.5),
        ),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            GridView.count(
              ...
              children: [
                _TelemetryCard(
                  title: isTalent ? 'Attributed ARR' : 'Total Capital Deployed',
                  value: isTalent ? '\$14,240' : '\$128,500',
                  trend: '+24.5% THIS CYCLE',
                  icon: Icons.monetization_on_outlined,
                  accentColor: accentColor,
                ),
                _TelemetryCard(
                  title: isTalent ? 'Proof-of-Impact Ratio' : 'Engine ROI Factor',
                  value: isTalent ? '98.2%' : '4.2x',
                  trend: 'SYSTEM SECURE',
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.waves, color: accentColor.withValues(alpha: 0.4), size: 36),
                    const SizedBox(height: 12),
                    const Text(
            ...
            children: [
              ...
              Center(
                child: CircleAvatar(
                  ...
                  child: Icon(Icons.account_circle_outlined, color: accentColor, size: 50),
                ),
              ),
              const SizedBox(height: 16),
              const Text(
              ...
              Text(
                ...
                style: TextStyle(color: accentColor, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(color: Color(0xFF1A1A1A), height: 24),
                    _buildIdentityRow('Database Protocol', 'Supabase Realtime RLS'),
                  ],
                ),
              )
            ],
  ...
  Widget _buildIdentityRow(String label, String status) {
    return Row(
      ...
      children: [
        ...
        Text(status, style: const TextStyle(color: Colors.white, fontSize: 12, fontFamily: 'monospace', fontWeight: FontWeight.bold)),
      ],
    );
  }
}