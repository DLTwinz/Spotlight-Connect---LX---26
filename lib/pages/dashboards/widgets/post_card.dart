        ...
        child: Column(
          ...
          if (post.repostOfPostId != null) ...[
            _RepostAttribution(
              ...
              originalAuthorName: (post.repostOfAuthorDisplayName?.trim().isNotEmpty ?? false)
                  ? post.repostOfAuthorDisplayName!
                  : 'Original post',
              originalAuthorRole: post.repostOfAuthorPrimaryRole ?? 'audience',
            ...
            Row(
              ...
              children: [
                InkWell(
                  ...
                  child: _RoleAvatar(role: post.authorPrimaryRole, label: post.authorDisplayName),
                ),
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Text(post.authorDisplayName, style: theme.textTheme.titleSmall?.bold, maxLines: 1, overflow: TextOverflow.ellipsis),
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
                          _RoleBadge(label: roleLabel, role: post.authorPrimaryRole),
                        ],
                      ),
          ...
          if (post.text.trim().isNotEmpty) ...[
            const SizedBox(height: AppSpacing.md),
            Text(post.text, style: theme.textTheme.bodyLarge?.copyWith(height: 1.45)),
          ],
          if (post.tags.isNotEmpty) ...[
            ...
            Wrap(
              ...
              children: post.tags.take(6).map((t) => _TagChip(tag: t)).toList(),
            ),
          ],
            ...
            Row(
              children: [
                _ActionPill(
                  ...
                  onTap: () => context.read<PostService>().toggleLike(post.postId),
                ),
                const SizedBox(width: 8),
                _ActionPill(
                  ...
                  onTap: () => showModalBottomSheet<void>(
                    ...
                    builder: (_) => ViewportConstrainedSheet(child: CommentsSheet(post: post)),
                  ),
                ),
                const SizedBox(width: 8),
                _ActionPill(
                  ...
                  color: reposted ? theme.colorScheme.secondary : theme.colorScheme.onSurfaceVariant,
                  onTap: () {
                ...
                IconButton(
                  ...
                  onPressed: () => context.read<PostService>().toggleSave(post.postId),
                  icon: Icon(saved ? Icons.bookmark : Icons.bookmark_border, color: saved ? theme.colorScheme.primary : theme.colorScheme.onSurfaceVariant),
                ),
                IconButton(
                  tooltip: 'Share',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(child: Text('Share', style: theme.textTheme.titleLarge?.bold)),
                      IconButton(onPressed: () => context.pop(), icon: Icon(Icons.close, color: theme.colorScheme.onSurfaceVariant)),
                    ],
                  ),
                  ...
                  ListTile(
                    ...
                    title: Text('Copy text', style: theme.textTheme.titleSmall?.bold),
                    subtitle: Text('Copies a spotlight-ready caption', style: theme.textTheme.bodySmall?.withColor(theme.colorScheme.onSurfaceVariant)),
                    onTap: () async {
                      context.pop();
                  ...
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(Icons.link, color: theme.colorScheme.onSurfaceVariant),
                    title: Text('Copy link', style: theme.textTheme.titleSmall?.bold),
                    subtitle: Text('Copies a link you can share', style: theme.textTheme.bodySmall?.withColor(theme.colorScheme.onSurfaceVariant)),
                    onTap: () async {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(child: Text('Post actions', style: theme.textTheme.titleLarge?.bold)),
                      IconButton(
                  ...
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(Icons.copy, color: theme.colorScheme.onSurfaceVariant),
                    title: Text('Copy', style: theme.textTheme.titleSmall?.bold),
                    subtitle: Text('Copy text for sharing', style: theme.textTheme.bodySmall?.withColor(theme.colorScheme.onSurfaceVariant)),
                    onTap: () async {
                      context.pop();
                      await _share(context);
                    },
                  ...
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(Icons.report_outlined, color: theme.colorScheme.onSurfaceVariant),
                    title: Text('Report', style: theme.textTheme.titleSmall?.bold),
                    subtitle: Text('Helps keep Spotlight safe', style: theme.textTheme.bodySmall?.withColor(theme.colorScheme.onSurfaceVariant)),
                    onTap: () {
                      debugPrint('Report postId=${post.postId}');
                      context.pop();
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Thanks — we’ll review this.')));
                    },
                  ),
                ],
              ),
...
class _RoleBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(label, style: theme.textTheme.labelSmall?.bold.withColor(theme.colorScheme.onSurface)),
    );
  }
}
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: theme.textTheme.labelLarge?.bold.withColor(theme.colorScheme.onSurface),
                  overflow: TextOverflow.ellipsis,
                ),
              ),
            ],
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(originalAuthorName, style: theme.textTheme.titleSmall?.bold),
                    const SizedBox(height: 2),
                    Text(
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(child: Text('Comments', style: theme.textTheme.titleLarge?.bold)),
                    IconButton(
                      onPressed: () => context.pop(),
                      icon: Icon(Icons.close, color: theme.colorScheme.onSurfaceVariant),
                    ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(999),
                            borderSide: BorderSide(color: theme.colorScheme.primary.withValues(alpha: 0.8)),
                          ),
                    ...
                    IconButton.filled(
                      onPressed: user == null || _sending ? null : _sendIfPossible,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _RoleAvatar(role: comment.authorPrimaryRole, label: comment.authorDisplayName),
          const SizedBox(width: AppSpacing.md),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    Expanded(child: Text(comment.authorDisplayName, style: theme.textTheme.titleSmall?.bold)),
                    Text(
                ...
                Text(comment.text, style: theme.textTheme.bodyMedium?.copyWith(height: 1.35)),
              ],
            ),
          ),
        ],
...
class _TagChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text('#$tag', style: theme.textTheme.labelMedium?.withColor(theme.colorScheme.onSurfaceVariant)),
    );
  }
}
