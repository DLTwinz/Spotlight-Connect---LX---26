    ...
    switch (kind) {
      case CreatorWorkspaceKind.momentum:
        return const _WorkspaceContent(
          ...
          detail:
              'Use this sample planning view to identify the next creator action worth taking.',
      ...
      case CreatorWorkspaceKind.workflow:
        return const _WorkspaceContent(
          ...
          detail:
              'A focused working surface for planning, producing, and closing the next piece of work.',
      ...
      case CreatorWorkspaceKind.portfolio:
        return const _WorkspaceContent(
          ...
          detail:
              'Use this sample readiness view to keep proof aligned with the work you want next.',
          action: 'Add proof asset',
      ...
      case CreatorWorkspaceKind.community:
        return const _WorkspaceContent(
          ...
          detail:
              'A sample community-planning view for deciding where engagement can matter most.',
      ...
      case CreatorWorkspaceKind.programs:
        return const _WorkspaceContent(
          ...
          detail:
              'A sample offer-design view for shaping how businesses and collaborators engage your work.',
      ...
      case CreatorWorkspaceKind.analytics:
        return const _WorkspaceContent(
          ...
          detail:
              'Use this sample planning view to decide which activity deserves attention next.',
      ...
      case CreatorWorkspaceKind.profile:
        return const _WorkspaceContent(
          ...
          detail:
              'A sample readiness view for the identity, proof, and preferences others encounter first.',
          action: 'Edit profile',
          ...
          FilledButton.icon(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    '${content.action} is ready for the next build.',
                  ),
                ),
              );
            },
