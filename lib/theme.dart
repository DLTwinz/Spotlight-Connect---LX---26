...
class LightModeColors {
  ...
  static const lightOnSurface = Color(0xFF111111);
  ...
  Color roleAccent(String? role) {
    switch (dashboardRoleVariant(role)) {
      case DashboardRoleVariant.admin:
        return SpotlightTokens.roleAdmin;
      case DashboardRoleVariant.business:
        return SpotlightTokens.roleBusiness;
      case DashboardRoleVariant.audience:
        return SpotlightTokens.roleAudience;
      case DashboardRoleVariant.talent:
        return SpotlightTokens.roleTalent;
    }
  }

  Color roleShellBackground(String? role) {
    return SpotlightTokens.shellBg;
  }

  Color rolePanelBackground(String? role) {
    return SpotlightTokens.shellPanel;
  }

  Color rolePanelBorder(String? role) {
    switch (dashboardRoleVariant(role)) {
      case DashboardRoleVariant.admin:
        return SpotlightTokens.border;
      case DashboardRoleVariant.business:
        return SpotlightTokens.roleBusiness.withValues(alpha: 0.28);
      case DashboardRoleVariant.audience:
        return SpotlightTokens.roleAudience.withValues(alpha: 0.28);
      case DashboardRoleVariant.talent:
        return SpotlightTokens.roleTalent.withValues(alpha: 0.28);
    }
  }

  Color roleNavBackground(String? role) {
    return SpotlightTokens.shellNav;
  }
...
ThemeData get darkTheme => ThemeData(
  ...
  scaffoldBackgroundColor: SpotlightTokens.bgPrimary,
  appBarTheme: const AppBarTheme(
    backgroundColor: Colors.transparent,
