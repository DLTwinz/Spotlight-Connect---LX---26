    ...
    try {
      ...
      if (user != null) {
        ...
        if (profile != null && mounted) {
          setState(
            () => _currentUserName = profile['display_name'] ?? 'USER NODE',
          );
        }
      }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('TRANSMISSION BLOCK: Security policy restriction.'),
          ),
        );
      }
    }
                      ...
                      : StreamBuilder<List<Map<String, dynamic>>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (messages.isEmpty) {
                              return const Center(
                                child: Text(
                                  'CHANNEL STREAM DORMANT // AWAITING DATA',
                                  style: TextStyle(
