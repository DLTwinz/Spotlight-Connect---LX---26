...
class AudienceDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("AUDIENCE INSIGHTS", style: TextStyle(letterSpacing: 2)),
      ...
      body: LayoutBuilder(builder: (context, constraints) {
        return ListView(
          ...
          children: [
            const Text("LIVE PERFORMANCE", style: TextStyle(color: Colors.grey, fontSize: 12)),
            ...
            const Text("LATEST ENGAGEMENT", style: TextStyle(color: Colors.grey, fontSize: 12)),
            const SizedBox(height: 16),
            SizedBox(
              height: 400,
